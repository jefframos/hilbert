...
Shader "Ciconia Studio/Effects/Ghost/Ghost Animated (UV Projection)" {
    Properties {
        ...
        [Space(10)][MaterialToggle] _InvertEffect ("Invert Effect", Float ) = -1
        ...
        _RotationDegree ("Rotation (Degree)", Float ) = -30
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_7154_ang = (((_RotationDegree*3.141592654)/180.0)+90.0);
...
////// Emissive:
                ...
                float node_6029 = (node_5849*node_5849*node_5849);
                float3 node_7250 = ((_Color.rgb*lerp( node_6029, (node_6029*-1.0+1.0), _InvertFresnel ))*_EmissiveIntensity);
